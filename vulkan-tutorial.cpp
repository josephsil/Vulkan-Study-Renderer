...
private:
	...
	void createTextureImage() {
		...
		transitionImageLayout(textureImage, VK_FORMAT_R8G8B8A8_SRGB, 
			VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL); //JS: Prepare image to read in shaders
...
because we won't come close to hitting any of these limits for now.*/
	...
	void drawFrame() {
		...
		recordCommandBuffer(commandBuffers[currentFrame], imageIndex, _selectedShader == 0 ? graphicsPipeline_1 : graphicsPipeline_2, placeholderMesh);
