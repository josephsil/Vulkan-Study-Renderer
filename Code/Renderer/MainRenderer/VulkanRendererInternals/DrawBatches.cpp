                                    ...
                                    std::span<FullShaderHandle> shaderIDs, const char* name)
{
 ...
 return RenderBatch{
      ...
      .depthBiasSetting =!shadow ?depthBiasSettng{.use =false, .depthBias = 0, .slopeBias = 0} : depthBiasSettng{.use = true, .depthBias = -6.0, .slopeBias = -3.0} //todo js: is this right for reverse?
          };
}
